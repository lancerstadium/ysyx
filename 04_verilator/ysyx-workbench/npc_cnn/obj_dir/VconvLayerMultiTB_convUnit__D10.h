...
#ifndef VERILATED_VCONVLAYERMULTITB_CONVUNIT__D10_H_
#define VERILATED_VCONVLAYERMULTITB_CONVUNIT__D10_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VconvLayerMultiTB_convUnit__D10 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VconvLayerMultiTB_convUnit__D10(VconvLayerMultiTB__Syms* symsp, const char* v__name);
    ~VconvLayerMultiTB_convUnit__D10();
    VL_UNCOPYABLE(VconvLayerMultiTB_convUnit__D10);
