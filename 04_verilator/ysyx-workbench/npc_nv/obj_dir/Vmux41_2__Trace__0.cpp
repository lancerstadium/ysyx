...
void Vmux41_2___024root__trace_chg_0_sub_0(Vmux41_2___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vmux41_2___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux41_2___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vmux41_2___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vmux41_2___024root__trace_chg_0_sub_0(Vmux41_2___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vmux41_2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vmux41_2___024root__trace_chg_0_sub_0\n"); );
    // Init
